...
from watercrawl.integrations.storage.lakehouse import build_lakehouse_writer
...
if TYPE_CHECKING:
    from watercrawl.integrations.contracts.dbt_runner import (
...
def _get_cli_override(name: str, default: T) -> T:
    ...
    cli_module = sys.modules.get("watercrawl.interfaces.cli")
