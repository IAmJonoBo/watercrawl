...
from watercrawl.domain.contracts import export_contract_registry
from watercrawl.governance.secrets import SecretsProvider

logger = logging.getLogger(__name__)

ENTRYPOINT_GROUP_PREFIX = "watercrawl.integrations"
...
class PluginContext:
    ...
    def default(cls) -> PluginContext:
        from watercrawl.core import config as core_config
