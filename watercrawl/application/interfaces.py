...
from watercrawl.domain.models import EvidenceRecord, PipelineReport
from watercrawl.integrations.telemetry.lineage import LineageContext
...
class PipelineService(ABC):
    ...
    def last_contract(
        self,
    ) -> PipelineReportContract | None:  # pragma: no cover - optional helper
